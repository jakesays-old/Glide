    ...
    public static class GlideUtils
    {
        ...
        public static class Convert
        {
            ...
            public static Color ToColor(string hexCode)
            {
                ...
                return (Color)((c >> 16) | (c & 0x00FF00) | ((c & 0x0000FF) << 16));
            }
...
//                Microsoft.SPOT.Debug.Print(label + " [ " + str + " ]");
            }
        }
...
//                    Microsoft.SPOT.Debug.Print(label + " - " + (Ticks / TimeSpan.TicksPerMillisecond) + "ms");
                }
                //else
                //    Microsoft.SPOT.Debug.Print(label + " - ERROR (Ticks equal zero)");
            }
        }
    }
}
